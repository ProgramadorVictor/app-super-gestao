    ...
    <div class="conteudo-pagina">
        ...
        <div class="informacao-pagina">
            ...
            <form action={{route('site.login')}} method="post">
                ...
                {{-- A váriavel $errors existe somente no contexto da view. --}}
                <button type="submit" class="borda-preta">Acessar</button> 
            </form>
            {{isset($erro) && $erro != '' ? $erro : ''}} {{-- Se váriavel erro existir e for diferente de vazio, printa a mensagem de erro no controlador, se não deixa vazio--}}
            </div>
        </div>
    </div>
