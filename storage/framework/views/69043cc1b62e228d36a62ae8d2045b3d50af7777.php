...
<div class="conteudo-pagina">
    ...
    <div class="informacao-pagina">
        <div style="width: 30%; margin-left: auto; margin-right:auto;">
            <form autocomplete="off" method="post" action="<?php echo e(route('produto.update', ['produto' => $produto->id] )); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('app.layouts.basico', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Usuários\victor.andrade\Desktop\Victor\app_super_gestao\resources\views/app/produto/edit.blade.php ENDPATH**/ ?>